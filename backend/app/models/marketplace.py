...
class MarketplaceCategory(Base):
    ...
    products: Mapped[list["MarketplaceProduct"]] = relationship(
        "MarketplaceProduct", back_populates="category_rel",
        foreign_keys="MarketplaceProduct.category_id",
    )
...
class MarketplaceVendor(Base):
    ...
    products: Mapped[list["MarketplaceProduct"]] = relationship(
        "MarketplaceProduct", back_populates="vendor_rel",
        foreign_keys="MarketplaceProduct.vendor_id",
    )
...
class MarketplaceProduct(Base):
    ...
    image: Mapped[str | None] = mapped_column(String(500), nullable=True)
    category_id: Mapped[uuid.UUID | None] = mapped_column(UUID(as_uuid=True), ForeignKey("marketplace_categories.id"), nullable=True)
